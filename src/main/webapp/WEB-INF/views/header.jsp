...
<head>
  ...
  <title>IPFSDownload Monitor</title>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="<c:url value="/bower_components/jvectormap/jquery-jvectormap.css"/>">
  <!-- DataTables -->
  ...
  <link rel="stylesheet" href="<c:url value="/css/ipfsdownloadmonitor.css"/>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
		<div class="logo">
	      <span class="logo-lg"><a style="color: white;" href="<c:url value="/"/>"><b>IPFSDownload</b>Monitor</a></span>
	    </div>
